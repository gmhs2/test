...
1. Use a browser from your device. Below are some examples of possible options:  
![im79]
...
|---|---|:-:|
|I.|Sorry, no results were found. Please try again  ![im80]|Click Back to Search and try to amend the filters or the location you entered. If still no results show up; unfortunately there is no properties available for your location. |
|II.|Username Already Exists - Please Try Again.  ![im81]|Click 'Already a member? Click here to login' then enter login details or if you do not have an account; please select a different username|
